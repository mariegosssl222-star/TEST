...
task.spawn(function()
	...
	while task.wait(0.5) do
		if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\194\80\162\185\55\186\234\75", "\213\131\37\214\214\125")] and isInLobby() and not _G_InventoryActionInProgress) then
			local hrp = getHRP();
			local human = getChar() and getChar():FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\14\62\40\190\239\41\34\33", "\129\70\75\69\223"));
			...
			if chosenPortal then
				...
				if (success and (path.Status == Enum.PathStatus.Success)) then
					...
					local targetWalkSpeed = 40;
					local walkedSuccessfully = false;
					while (currentWaypointIndex <= #waypoints) and Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\107\162\8\218\107\131\170\68", "\195\42\215\124\181\33\236")] and isInLobby() do
						local destination = waypoints[currentWaypointIndex].Position;
						human.WalkSpeed = targetWalkSpeed;
						human:MoveTo(destination);
						if ((hrp.Position - destination).Magnitude < 8) then
							currentWaypointIndex = currentWaypointIndex + 1;
						end
						local countLabel = chosenPortal:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\46\86\34\48\49\199\57\65\35", "\152\109\57\87\94\69"), true);
						if (not countLabel or (countLabel.Text ~= LUAOBFUSACTOR_DECRYPT_STR_0("\169\152\94", "\200\153\183\106\195\222\178\52"))) then
							break;
						end
					...
					if walkedSuccessfully then
						local distanceToPortal = (hrp.Position - targetPosition).Magnitude;
						if (distanceToPortal < 15) then
							local countLabel = chosenPortal:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\17\236\157\51\93\101\6\251\156", "\58\82\131\232\93\41"), true);
							if (countLabel and (countLabel.Text == LUAOBFUSACTOR_DECRYPT_STR_0("\211\24\132", "\95\227\55\176\117\61"))) then
								hrp.CFrame = CFrame.new(targetPosition.X, targetPosition.Y + 1, targetPosition.Z);
								task.wait(0.2);
								local difficulty = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\53\127\51\111\162\30\120", "\203\120\30\67\43")] or LUAOBFUSACTOR_DECRYPT_STR_0("\223\42\95\226\216\253", "\185\145\69\45\143");
								teleportEvent:FireServer(chosenPortal, 1, difficulty);
								task.wait(5);
							end
						end
					end
...
task.spawn(function()
	local remote = ReplicatedStorage:WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\184\26\20\169\200\143\12", "\188\234\127\121\198")):WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\10\55\2\150\61\33\7\176\47\59\29\132", "\227\88\82\115"));
	...
	local skills = {LUAOBFUSACTOR_DECRYPT_STR_0("\112\20\179\171\14\76\18", "\19\35\127\218\199\98"),LUAOBFUSACTOR_DECRYPT_STR_0("\47\240\3\238\16\196\88", "\130\124\155\106"),LUAOBFUSACTOR_DECRYPT_STR_0("\230\192\255\163\175\201\47", "\223\181\171\150\207\195\150\28"),LUAOBFUSACTOR_DECRYPT_STR_0("\127\49\234\162\5\115\110", "\105\44\90\131\206"),LUAOBFUSACTOR_DECRYPT_STR_0("\204\245\176\134\89", "\94\159\128\210\217\104"),LUAOBFUSACTOR_DECRYPT_STR_0("\99\236\4\128\13", "\26\48\153\102\223\63\31\153")};
	local idx = 1;
	while task.wait() do
		if (not isInLobby() and isSafeToAct and areMobsPresent()) then
			if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\35\78\249\250\50\76\236\234\7\82", "\147\98\32\141")] then
				continue;
			end
			if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\57\86\247\197\39\66\95\25\64\232", "\43\120\35\131\170\102\54")] and not _G_InventoryActionInProgress) then
				pcall(function()
					remote:FireServer({[LUAOBFUSACTOR_DECRYPT_STR_0("\87\10\142\179\171\164\176\93\11\130", "\228\52\102\231\214\197\208")]=nil});
				end);
			end
			if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\63\245\97\197\217\128\16\218\18", "\182\126\128\21\170\138\235\121")] then
				pcall(function()
					local s = skills[idx];
					if s:find(LUAOBFUSACTOR_DECRYPT_STR_0("\184\207\55", "\102\235\186\85\134\230\115\80")) then
						subRem:FireServer(s);
					else
				...
				idx = (idx % #skills) + 1;
				task.wait(Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\100\7\55\83\126\247\6", "\66\55\108\94\63\18\180")] or 0.5);
			end
			if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\53\152\145\56\18\85\0", "\57\116\237\229\87\71")] then
				pcall(function()
					ultRem:FireServer(LUAOBFUSACTOR_DECRYPT_STR_0("\159\189\249\238\122\239\83\175", "\39\202\209\141\135\23\142"));
				end);
			end
		end
	end
...
RunService.Heartbeat:Connect(function()
	if (not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\203\35\61\5\31\247\253", "\152\159\83\105\106\82")] or isInLobby() or _G_InventoryActionInProgress or isCollecting) then
	...
	if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\14\16\59\35\49\11\46\7\42\56", "\103\79\126\79\74\97")] then
		if (getChar() and getChar():FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\146\106\222\114\80\21\179\123", "\122\218\31\179\19\62"))) then
			getChar().Humanoid.AutoRotate = true;
		end
		return;
	end
	...
	if (not currentTarget or not currentTarget.Parent or (currentTarget:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\155\195\192\192\199\174\76\183", "\37\211\182\173\161\169\193")) and (currentTarget.Humanoid.Health <= 0))) then
		local closest, dist = nil, 8999999488;
		for _, f in pairs({Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\218\53\78\210\6\75\154", "\217\151\90\45\185\72\27")),Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\230\114\226\31\95\198\111", "\54\163\28\135\114"))}) do
			if f then
				for _, v in ipairs(f:GetChildren()) do
					if (v:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\0\206\80\131\64\112\33\223\111\141\65\107\24\218\79\150", "\31\72\187\61\226\46")) and v:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\235\19\78\211\73\113\45\199", "\68\163\102\35\178\39\30")) and (v.Humanoid.Health > 0)) then
	...
	if currentTarget then
		...
		local mode = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\138\96\234\200\16", "\113\222\16\186\167\99\213\227")];
		local dist = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\26\30\223\255\61\26", "\150\78\110\155")];
		local offset = CFrame.new(0, 0, 0);
		if (mode == LUAOBFUSACTOR_DECRYPT_STR_0("\167\196\36\234", "\32\229\165\71\129\196\126\223")) then
			offset = tHrp.CFrame * CFrame.new(0, 0, dist);
		elseif (mode == LUAOBFUSACTOR_DECRYPT_STR_0("\229\155\203\143\149", "\181\163\233\164\225\225")) then
			offset = tHrp.CFrame * CFrame.new(0, 0, -dist);
		elseif (mode == LUAOBFUSACTOR_DECRYPT_STR_0("\113\137\49\97\85", "\23\48\235\94")) then
			offset = tHrp.CFrame * CFrame.new(0, dist, 0) * CFrame.Angles(math.rad(-90), 0, 0);
		elseif (mode == LUAOBFUSACTOR_DECRYPT_STR_0("\94\223\212\82\64", "\178\28\186\184\61\55\83")) then
			offset = tHrp.CFrame * CFrame.new(0, -dist, 0) * CFrame.Angles(math.rad(90), 0, 0);
		end
		hrp.CFrame = offset;
		hrp.Velocity = Vector3.zero;
		getChar().Humanoid.AutoRotate = (mode == LUAOBFUSACTOR_DECRYPT_STR_0("\230\204\68\55", "\149\164\173\39\92\146\110")) or (mode == LUAOBFUSACTOR_DECRYPT_STR_0("\213\53\31\17\14", "\123\147\71\112\127\122"));
	end
end);
task.spawn(function()
	while task.wait(4) do
		if ((Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\225\204\146\85\79\202\203", "\38\172\173\226\17")] ~= LUAOBFUSACTOR_DECRYPT_STR_0("\127\16\37\235", "\143\45\113\76")) and Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\153\173\8\51\155\176\25\47\172", "\92\216\216\124")] and Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\120\51\191\69", "\157\59\82\204\32")) and getHRP()) then
...
task.spawn(function()
	while task.wait(0.1) do
		if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\25\43\247\245\202\229\223\189\61\61\247", "\209\88\94\131\154\137\138\179")] and Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\12\179\203\108\56\44\61\38\45\179", "\66\72\193\164\28\126\67\81"))) then
			isCollecting = true;
			for _, v in ipairs(Workspace.DropFolder:GetChildren()) do
				if (v:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\197\45\187\93\22\119\245\56", "\22\135\76\200\56\70")) and getHRP()) then
...
task.spawn(function()
	while task.wait(1) do
		if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\172\37\236\43\113\238\143\50\225", "\129\237\80\152\68\61")] and not isInLobby()) then
			local endScreen = Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\117\173\6\225\21\4\126\94\164\0\246\14", "\56\49\200\100\147\124\119")) and Workspace.DebrisFolder:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\255\61\173\245\201\48\154\254\200", "\144\172\94\223"));
			if endScreen then
				if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\9\14\178\99\45\9\164", "\39\68\111\194")] == LUAOBFUSACTOR_DECRYPT_STR_0("\228\167\238\195", "\215\182\198\135\167\25")) then
					task.wait(0.5);
				else
					task.wait(5);
				end
		...
		if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\190\66\227\88\161\70\235\76", "\40\237\41\138")] then
			local ls = lp.PlayerGui:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\235\123\251\252\67\201\115\201\251\88\194\113\244", "\42\167\20\154\152"));
			if (ls and ls.Enabled) then
				local btn = ls:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\104\234\172\125\66\42\67\238", "\65\42\158\194\34\17"), true);
				if btn then
