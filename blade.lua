...
task.spawn(function()
	...
	if debrisFolder then
		debrisFolder.ChildAdded:Connect(function(child)
			if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\218\56\242\176\225\149\240\19\251\176", "\218\158\87\150\215\132")] or not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\218\11\205\237\18\45\201\252\27", "\173\155\126\185\130\86\66")] or isInLobby() or _G_isCaseActive or _G_WaitingForCase) then
				return;
			end
			if child:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\199\167\169\194\184\237\247\178", "\140\133\198\218\167\232")) then
				local hrp = getHRP();
...
local function findBestMob(origin)
	local best, bestDist;
	for _, f in pairs({Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\152\33\183\118\170\133\13", "\228\213\78\212\29")),Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\162\66\179\8\226\130\95", "\139\231\44\214\101"))}) do
		if f then
			for _, mob in ipairs(f:GetChildren()) do
				local hum = mob:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\241\250\11\95\30\190\56\18", "\118\185\143\102\62\112\209\81"));
				local hrp = mob:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\116\101\36\231\171\26\21\60\110\127\38\242\149\20\14\44", "\88\60\16\73\134\197\117\124")) or mob:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\100\229\234\219\78", "\33\48\138\152\168")) or mob:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\71\6\32\84\211\3\125\4\35\94", "\87\18\118\80\49\161"));
...
RunService.Heartbeat:Connect(function()
	if not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\120\14\238\175\157\67\28", "\208\44\126\186\192")] then
		return;
	end
	...
	lastTP = tick();
	if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\214\20\176\207\36\240\200\87\242\8", "\46\151\122\196\166\116\156\169")] and areOtherPlayersPresent() and not isInLobby()) then
		return;
	end
	...
	local char = getChar();
	local hrp = getHRP();
	local human = char and char:FindFirstChildOfClass(LUAOBFUSACTOR_DECRYPT_STR_0("\205\248\75\27\245\234\228\66", "\155\133\141\38\122"));
	...
	local tHum = currentTarget:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\13\63\161\64\65\112\172\33", "\197\69\74\204\33\47\31"));
	local tHrp = currentTarget:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\216\90\87\134\254\64\83\131\194\64\85\147\192\78\72\147", "\231\144\47\58")) or currentTarget:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\134\215\200\102\23", "\89\210\184\186\21\120\93\175")) or currentTarget:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\132\67\108\208\107\14\190\65\111\218", "\90\209\51\28\181\25"));
	...
	local dist = math.max(Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\228\107\115\231\172\196", "\223\176\27\55\142")] or SAFE_MIN_DIST, SAFE_MIN_DIST);
...
task.spawn(function()
	local dropFolder = Workspace:WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\0\169\193\165\2\180\194\177\33\169", "\213\68\219\174"));
	local function doCollect()
		if checkAntiPlayerAndPause() then
			return;
		end
		if (not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\42\245\55\232\9\202\51\115\14\227\55", "\31\107\128\67\135\74\165\95")] or _G_isCaseActive or _G_WaitingForCase) then
			return;
		end
		local targets = {};
		...
		if (#targets >= 5) then
			...
			for _, v in ipairs(targets) do
				...
				if (not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\38\221\97\7\155\8\196\121\13\187\19", "\216\103\168\21\104")] or _G_isCaseActive or _G_WaitingForCase) then
					break;
				end
				local targetPart = (v:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\90\172\80\161\72\172\81\176", "\196\24\205\35")) and v) or v:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\3\138\234\8", "\102\78\235\131")) or v:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\210\47\58\64\75\60", "\84\154\78\84\36\39\89\215")) or v.PrimaryPart;
...
task.spawn(function()
	local teleportEvent = ReplicatedStorage:WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\207\228\91\87\17\248\198\99\113", "\101\157\129\54\56")):WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\40\157\143\167\38\105\18\187\158\136\44\119\27\160\152\166\6\111\24\167\158", "\25\125\201\234\203\67"));
	local tpGuiName = LUAOBFUSACTOR_DECRYPT_STR_0("\77\241\20\6\4\40\1\109", "\115\25\148\120\99\116\71");
	...
	while task.wait(0.1) do
		...
		if (not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\45\40\173\43\107\3\52\183", "\33\108\93\217\68")] or not isInLobby()) then
			_G_isAutoJoining = false;
			continue;
		end
		if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\250\94\181\162\241\68\168\163", "\205\187\43\193")] and isInLobby()) then
			local hrp = getHRP();
			local human = getChar() and getChar():FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\214\103\8\222\240\125\12\219", "\191\158\18\101"));
			local pGui = lp:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\245\207\134\174\170\215\228\146\190", "\207\165\163\231\215"));
			local tpGui = pGui and pGui:FindFirstChild(tpGuiName);
			if (not hrp or not human or not tpGui) then
				continue;
			end
			if (not _G_InventoryActionInProgress and (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\231\236\237\89\23\117\202\245", "\16\166\153\153\54\68")] or Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\243\166\212\73\16\40\234\223\186\212\67", "\153\178\211\160\38\84\65")]) and doesInventoryHaveTrash()) then
				if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\163\30\78\36\177\14\86\39", "\75\226\107\58")] then
					performInventoryAction(LUAOBFUSACTOR_DECRYPT_STR_0("\107\219\29\118", "\173\56\190\113\26\113\162"), nil, true);
				elseif Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\234\203\57\10\211\194\205\32\12\227\206", "\151\171\190\77\101")] then
					performInventoryAction(LUAOBFUSACTOR_DECRYPT_STR_0("\225\38\235\164\241\105\14", "\107\165\79\152\201\152\29"), nil, true);
				end
			end
			if _G_InventoryActionInProgress then
				task.wait(0.2);
			...
			if tpGui.Enabled then
				...
				hrp.Velocity = Vector3.zero;
				hrp.Anchored = true;
				local portals = (Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\99\75\228\206\68\112\69\90\251", "\31\55\46\136\171\52")) and Workspace.Teleports:GetChildren()) or {};
				local selectedDiff = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\252\41\204\208\216\46\218", "\148\177\72\188")] or LUAOBFUSACTOR_DECRYPT_STR_0("\136\185\69\222\167\186", "\179\198\214\55");
				if (selectedDiff == LUAOBFUSACTOR_DECRYPT_STR_0("\222\5\124\124\68\147\194\13\123\114", "\179\144\108\18\22\37")) then
					selectedDiff = LUAOBFUSACTOR_DECRYPT_STR_0("\244\162\18\141", "\175\166\195\123\233");
				end
				local targetPortal = nil;
				for _, p in ipairs(portals) do
					if (p:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\204\205\81\69\249\252\203\82\71", "\144\143\162\61\41")) and ((hrp.Position - p.Collision.Position).Magnitude < 10)) then
						targetPortal = p;
						break;
					end
				end
				...
				task.wait(2);
				if (tpGui.Enabled and Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\193\198\9\95\88\136\58\238", "\83\128\179\125\48\18\231")]) then
					pcall(function()
						teleportEvent:FireServer(targetPortal, 1, selectedDiff);
					end);
				end
				while tpGui.Enabled and Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\124\162\231\210\109\17\84\185", "\126\61\215\147\189\39")] and isInLobby() do
					task.wait(6);
					if (tpGui.Enabled and Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\89\234\9\74\82\240\20\75", "\37\24\159\125")]) then
						pcall(function()
							teleportEvent:FireServer(targetPortal, 1, selectedDiff);
						end);
					end
				...
				local portals = (Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\238\163\121\71\202\169\103\86\201", "\34\186\198\21")) and Workspace.Teleports:GetChildren()) or {};
				local chosenPortal = nil;
				for _, p in ipairs(portals) do
					local txt = p:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\219\7\208\83\214\199\60\221\73", "\162\152\104\165\61"), true);
					if (txt and txt.Text:find(LUAOBFUSACTOR_DECRYPT_STR_0("\157\96", "\133\173\79\210\29\16"))) then
						chosenPortal = p;
						break;
					end
				end
				if (chosenPortal and chosenPortal:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\174\115\225\39\132\111\228\36\131", "\75\237\28\141"))) then
					...
					while moveTimeout < 10000000 do
						...
						if not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\253\74\216\190\5\20\238\239", "\129\188\63\172\209\79\123\135")] then
							_G_isAutoJoining = false;
							human.WalkSpeed = DEFAULT_WALKSPEED;
							break;
						end
						local currentTxt = chosenPortal:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\99\235\243\195\84\219\210\213\84", "\173\32\132\134"), true);
						if (not currentTxt or not currentTxt.Text:find(LUAOBFUSACTOR_DECRYPT_STR_0("\30\84", "\173\46\123\104\143\206\81"))) then
...
task.spawn(function()
	while true do
		task.wait(1);
		if (not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\149\8\54\133\102\139\4\167\9", "\97\212\125\66\234\37\227")] or not isInLobby()) then
			continue;
		end
		...
		pcall(function()
			...
			if caseModel then
				for _, d in ipairs(caseModel:GetDescendants()) do
					if (d:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\26\190\17\13\8\190\16\28", "\104\88\223\98")) or d:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\96\242\225\207\14", "\141\36\151\130\174\98"))) then
						d.Transparency = 1;
					elseif d:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\180\123\208\25\141\121\206\8\161\119\203\25\144\127\208", "\109\228\26\162")) then
						d.Enabled = false;
					end
				end
			end
			local openChest = ReplicatedStorage:WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\120\240\243\123\244\239\81\235\238", "\134\62\133\157\24\128")):WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\40\181\31\215\12\185\211\20\177\60\204\33\178", "\182\103\197\122\185\79\209"));
			if openChest then
...
task.spawn(function()
	while task.wait(0.5) do
		...
		local diff = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\222\134\241\83\9\78\245", "\40\147\231\129\23\96")];
		local isRaid = (diff == LUAOBFUSACTOR_DECRYPT_STR_0("\71\249\133\65", "\188\21\152\236\37\219\204")) or (diff == LUAOBFUSACTOR_DECRYPT_STR_0("\110\224\57\6\65\169\5\13\73\237", "\108\32\137\87"));
		if (isInLobby() or isRaid) then
			_G_isCaseActive = false;
			_G_WaitingForCase = false;
			continue;
		end
		local endScreen = Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\142\237\2\180\38\234\109\86\166\236\5\180", "\57\202\136\96\198\79\153\43")) and Workspace.DebrisFolder:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\152\32\184\162\136\169\221\165\39", "\152\203\67\202\199\237\199"));
		local case = Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\217\66\179\10", "\134\154\35\192\111\127\21\25"));
		if (endScreen and not case) then
			...
			while (timeout > 0) and not case do
				task.wait(0.1);
				timeout = timeout - 1;
				case = Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\155\39\26\15", "\178\216\70\105\106\64"));
			end
			if not case then
				_G_WaitingForCase = false;
				pcall(function()
					ReplicatedStorage:WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\13\46\119\249\221\208\243\181\22", "\224\95\75\26\150\169\181\180")):WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\62\233\211\33\84\141\117\31\211\206\45\97\186\115\5\206", "\22\107\186\184\72\36\204")):FireServer(true);
				end);
				continue;
			end
		end
		...
		if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\196\178\40\66\11\228\169\3\71\8\243", "\110\135\221\68\46")] then
			local gifts = {};
			for _, v in ipairs(Workspace:GetChildren()) do
				if (v.Name == LUAOBFUSACTOR_DECRYPT_STR_0("\196\63\10\255", "\91\131\86\108\139\174\211")) then
			...
			for _, gift in ipairs(gifts) do
				...
				for _, d in ipairs(gift:GetDescendants()) do
					if d:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\217\42\171\18\109\250\57\172", "\61\155\75\216\119")) then
				...
				if targetGiftPart then
					...
					if hrp then
						...
						hrp.Velocity = Vector3.zero;
						task.wait(0.3);
						local prompt = gift:FindFirstChildOfClass(LUAOBFUSACTOR_DECRYPT_STR_0("\52\185\189\36\81\4\212\16\178\130\46\87\4\205\16", "\189\100\203\210\92\56\105"));
		...
		local function isInventoryFull()
			local full = false;
			pcall(function()
				local playerGui = lp:WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\31\93\252\49\42\67\218\61\38", "\72\79\49\157"));
				local inventoryFrame = playerGui:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\161\190\39\185\134\164\62\174\145", "\220\232\208\81"));
				if inventoryFrame then
					local slotLabel = inventoryFrame.Canvas.Main.Slot.Txt_Slot;
					if (slotLabel and slotLabel.Text and slotLabel.Text:find("/")) then
						local current, max = slotLabel.Text:match(LUAOBFUSACTOR_DECRYPT_STR_0("\198\178\234\36\63\0\225\189\251\225\123\101\21\233\176\186\174\121", "\193\149\222\133\80\76\58"));
		...
		if isInventoryFull() then
			if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\231\72\91\221\245\88\67\222", "\178\166\61\47")] then
				performInventoryAction(LUAOBFUSACTOR_DECRYPT_STR_0("\200\79\228\118", "\94\155\42\136\26\170"));
			elseif Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\165\42\50\186\160\54\53\184\141\43\35", "\213\228\95\70")] then
				performInventoryAction(LUAOBFUSACTOR_DECRYPT_STR_0("\14\178\209\137\126\62\190", "\23\74\219\162\228"));
			end
			local maxWait = 10;
		...
		local hrp = getHRP();
		local caseTarget = case:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\13\233\86", "\91\89\134\38\207")) or case:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\105\239\193\56", "\71\36\142\168\86\115\176")) or case.PrimaryPart or case:FindFirstChildOfClass(LUAOBFUSACTOR_DECRYPT_STR_0("\253\160\97\186\51\191\68\93", "\41\191\193\18\223\99\222\54"));
		if not caseTarget then
			_G_isCaseActive = false;
			continue;
		end
		local prompt = case:FindFirstChildOfClass(LUAOBFUSACTOR_DECRYPT_STR_0("\155\52\200\50\163\166\47\211\51\154\185\41\202\58\190", "\202\203\70\167\74"));
...
task.spawn(function()
	...
	pcall(function()
		UpgradeWeaponFunc = ReplicatedStorage:WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\198\233\14\83\251\233\243\14\67", "\143\128\156\96\48"), 5):WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\141\193\247\0\22\188\212\199\23\22\168\222\254\52\2\182\210", "\119\216\177\144\114"), 5);
	end);
	while task.wait(0.5) do
		if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\232\60\237\77\252\57\254\80\200\45\252", "\34\169\73\153")] and isInLobby() and UpgradeWeaponFunc) then
			pcall(function()
				UpgradeWeaponFunc:InvokeServer();
			end);
			task.wait(1 / (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\159\252\12\184\186\233\14\143", "\235\202\140\107")] or 3));
		end
	end
end);
...
task.spawn(function()
	while task.wait(1) do
		if (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\45\97\32\167\197\40\245\199\21", "\165\108\20\84\200\137\71\151")] and not isInLobby()) then
			local endScreen = Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\94\177\41\154\115\167\13\135\118\176\46\154", "\232\26\212\75")) and Workspace.DebrisFolder:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\4\74\96\237\242\57\108\124\236", "\151\87\41\18\136"));
			if endScreen then
			...
			if shouldLeave then
				if ((Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\118\174\218\244\247\93\169", "\158\59\207\170\176")] == LUAOBFUSACTOR_DECRYPT_STR_0("\97\87\61\67\141\15\108\50\64\136", "\236\47\62\83\41")) or (Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\215\168\48\31\163\132\252", "\226\154\201\64\91\202")] == LUAOBFUSACTOR_DECRYPT_STR_0("\243\72\20\28", "\220\161\41\125\120\42"))) then
					task.wait(0.5);
				else
					task.wait(5);
				end
				SendEndGameReport(LUAOBFUSACTOR_DECRYPT_STR_0("\145\112\180\13\180\49\134\7\178\120\179\6\185\117", "\110\220\17\192"), 65280, false);
				_G_isCaseActive = false;
				_G_WaitingForCase = false;
				pcall(function()
		...
		if Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\71\114\61\10\199\56\240\163", "\199\20\25\84\122\139\87\145")] then
			local ls = lp.PlayerGui:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\107\6\220\170\18\228\64\58\222\188\30\239\73", "\138\39\105\189\206\123"));
			if (ls and ls.Enabled) then
				local btn = ls:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\61\19\135\18\192\242\198\239", "\159\127\103\233\77\147\153\175"), true);
				if btn then
					btn.Selectable = true;
					btn.Active = true;
					...
					task.wait(0.01);
					VirtualInputManager:SendKeyEvent(false, Enum.KeyCode.Return, false, game);
					if btn:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\32\229\237\136\85\223\19\255\234", "\171\103\144\132\202\32")) then
						pcall(function()
							btn:FireTouchEnded();
						end);
					end
...
task.spawn(function()
	local debrisFolder = Workspace:WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\52\42\235\30\25\60\207\3\28\43\236\30", "\108\112\79\137"));
	local searchStartTime = 0;
	local HOP_TIMEOUT = 12;
	while task.wait(1) do
		if (not Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\26\204\117\42\161\4\207\60\49\198\113\58", "\85\95\162\20\72\205\97\137")] or not isInLobby()) then
			searchStartTime = 0;
			continue;
		end
		...
		local minRarity = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\209\244\36\216\63\249\223\254\233\51", "\173\151\157\74\188\109\152")];
		local displayWeapon = Library.Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\2\1\54\217\235\81\212\227\43\6\28\212\207\68\217\242\61", "\147\68\104\88\189\188\52\181")];
		local realWeapon = NameToReal[displayWeapon] or LUAOBFUSACTOR_DECRYPT_STR_0("\59\132\135\144\45\141\138\192\21\134\152", "\176\122\232\235");
		local minIdx = 1;
		...
		for _, dropContainer in ipairs(debrisFolder:GetChildren()) do
			if (dropContainer.Name == LUAOBFUSACTOR_DECRYPT_STR_0("\164\103\53\95\209\162\116\41\74", "\142\224\21\90\47")) then
				for _, weaponModel in ipairs(dropContainer:GetChildren()) do
					local wName = weaponModel.Name;
					local wRarity = LUAOBFUSACTOR_DECRYPT_STR_0("\87\219\42\91\171\133", "\229\20\180\71\54\196\235");
					for r, list in pairs(GameConfig.RarityMap) do
						for _, n in ipairs(list) do
							if (n == wName) then
								wRarity = r;
					...
					if (((realWeapon ~= LUAOBFUSACTOR_DECRYPT_STR_0("\8\114\205\163\194\175\129\57\113\207\240", "\224\73\30\161\131\149\202")) and isSpecificMatch) or ((realWeapon == LUAOBFUSACTOR_DECRYPT_STR_0("\208\233\253\16\198\224\240\64\254\235\226", "\48\145\133\145")) and isRarityMatch)) then
						table.insert(foundWeapons, {[LUAOBFUSACTOR_DECRYPT_STR_0("\87\67\177\235\221", "\76\58\44\213\142\177")]=weaponModel});
					end
				end
			end
		end
		...
		if ((#foundWeapons > 0) and hrp) then
			for _, w in ipairs(foundWeapons) do
				if (w.model and w.model.Parent) then
					local handle = w.model:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\227\37\28\41\116\206", "\24\171\68\114\77"));
					if handle then
		...
		elseif ((tick() - searchStartTime) > HOP_TIMEOUT) then
			SendEndGameReport(LUAOBFUSACTOR_DECRYPT_STR_0("\220\24\66\68\130\204\68\133\224\13\10\18\174\202\1\160\175\19\95\70\199\216\11\184\225\25", "\205\143\125\48\50\231\190\100"), 16711680, false);
			local PlaceID = game.PlaceId;
			local foundAnything = "";
			local function TPReturner()
				local Site;
				if (foundAnything == "") then
					Site = HttpService:JSONDecode(game:HttpGet(LUAOBFUSACTOR_DECRYPT_STR_0("\201\179\0\21\242\185\144\237\198\166\25\0\242\173\205\173\195\171\27\29\175\224\208\175\142\177\69\74\230\226\210\167\210\232", "\194\161\199\116\101\129\131\191") .. PlaceID .. LUAOBFUSACTOR_DECRYPT_STR_0("\163\55\205\186\225\167\254\55\135\152\226\160\224\45\203\247\228\173\254\48\231\186\243\167\254\121\236\173\228\161\170\40\193\165\254\182\177\117\152\248", "\194\140\68\168\200\151")));
				else
					Site = HttpService:JSONDecode(game:HttpGet(LUAOBFUSACTOR_DECRYPT_STR_0("\74\239\193\53\230\24\180\154\34\244\79\254\198\107\231\77\249\217\42\237\12\248\218\40\186\84\170\154\34\244\79\254\198\106", "\149\34\155\181\69") .. PlaceID .. LUAOBFUSACTOR_DECRYPT_STR_0("\76\238\208\232\21\248\199\233\76\205\192\248\15\244\214\165\16\242\199\238\44\239\209\255\17\160\241\255\16\254\147\246\10\240\220\238\94\172\133\170\69\254\192\232\16\242\199\167", "\154\99\157\181") .. foundAnything));
				end
				if (Site.nextPageCursor and (Site.nextPageCursor ~= LUAOBFUSACTOR_DECRYPT_STR_0("\131\26\224\172", "\140\237\111\140\192"))) then
