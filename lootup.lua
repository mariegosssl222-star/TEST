...
AutoMobToggle = MainTab:Toggle({[LUAOBFUSACTOR_DECRYPT_STR_0("\202\112\113\76", "\128\132\17\28\41\187\47")]=LUAOBFUSACTOR_DECRYPT_STR_0("\39\51\20\55\29\44\61\4", "\61\97\82\102\90"),[LUAOBFUSACTOR_DECRYPT_STR_0("\138\34\170\76", "\105\204\78\203\43\167\55\126")]=LUAOBFUSACTOR_DECRYPT_STR_0("\132\191\55\17\62\11\197", "\49\197\202\67\126\115\100\167"),[LUAOBFUSACTOR_DECRYPT_STR_0("\19\94\217\40\149\90\74", "\62\87\59\191\73\224\54")]=false,[LUAOBFUSACTOR_DECRYPT_STR_0("\196\3\246\197\229\3\249\194", "\169\135\98\154")]=function(v)
	if v then
		if (Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\237\118\54\89\222\59\218\194\100\48\89\252\32", "\168\171\23\68\52\157\83")] and FarmChristmasToggle) then
...
FarmChristmasToggle = MainTab:Toggle({[LUAOBFUSACTOR_DECRYPT_STR_0("\218\112\248\168", "\231\148\17\149\205\69\77")]=LUAOBFUSACTOR_DECRYPT_STR_0("\166\166\213\246\23\220\136\181\206\232\67\242\129\180", "\159\224\199\167\155\55"),[LUAOBFUSACTOR_DECRYPT_STR_0("\209\255\61\213", "\178\151\147\92")]=LUAOBFUSACTOR_DECRYPT_STR_0("\170\252\94\63\49\68\104\133\238\88\63\19\95", "\26\236\157\44\82\114\44"),[LUAOBFUSACTOR_DECRYPT_STR_0("\14\43\211\90\63\34\193", "\59\74\78\181")]=false,[LUAOBFUSACTOR_DECRYPT_STR_0("\6\208\86\86\177\36\210\81", "\211\69\177\58\58")]=function(v)
	if v then
		if (Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\150\240\109\250\196\196\181", "\171\215\133\25\149\137")] and AutoMobToggle) then
...
RunService.Heartbeat:Connect(function()
			...
			for _, mob in pairs(enemies:GetChildren()) do
				if (mob:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\90\253\201\162\5\76\112\118", "\25\18\136\164\195\107\35")) and (mob.Humanoid.Health > 0)) then
					...
					if root then
						...
						if (diffY <= 50) then
							if (selectedMob == LUAOBFUSACTOR_DECRYPT_STR_0("\201\33\165", "\216\136\77\201\47\18\220\161")) then
								if (dist < minDist) then
									minDist = dist;
									potentialTarget = mob;
								end
	...
	if Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\33\156\253\177\51\157\232\170", "\222\96\233\137")] then
		local remote = ReplicatedStorage:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\139\182\170\16\156\246\213\175\182\169\11\155", "\144\217\211\199\127\232\147")) and ReplicatedStorage.RemoteEvents:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\205\63\57\58\212\65\7\119\236\46\42", "\36\152\79\94\72\181\37\98"));
		if remote then
			remote:FireServer(Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\228\204\70\43\227\217\85\56\210\204", "\95\183\184\39")] or LUAOBFUSACTOR_DECRYPT_STR_0("\134\43\245\35\90\135\22\189", "\98\213\95\135\70\52\224"));
		end
	end
end);
RunService.RenderStepped:Connect(function()
	if not Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\219\144\249\90\91\252\176", "\52\158\195\169\23")] then
		return;
	end
	local enemies = Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\95\178\55\121\143\48\104", "\235\26\220\82\20\230\85\27"));
	if not enemies then
		return;
	end
	local selectedMob = Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\188\160\251\197\113\156\140\230\192", "\20\232\193\137\162")];
	local isSpecificMode = selectedMob and (selectedMob ~= "");
	for _, mob in pairs(enemies:GetChildren()) do
		local root = GetMobRoot(mob);
		if (root and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\10\202\200\167\233\131\30\117\16\208\202\178\215\141\5\101", "\17\66\191\165\198\135\236\119"))) then
			...
			if showESP then
				if not root:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\36\166\160\20\218\219\220", "\177\111\207\206\115\159\136\140")) then
					local bb = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\39\128\28\24\214\64\94\23\141\55\1\221", "\63\101\233\112\116\180\47"), root);
					bb.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\232\50\227\21\221\5\243", "\86\163\91\141\114\152");
					bb.Size = UDim2.new(0, 100, 0, 40);
					bb.AlwaysOnTop = true;
					bb.StudsOffset = Vector3.new(0, 3, 0);
					local tl = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\103\14\108\103\22\82\9\113\127", "\90\51\107\20\19"), bb);
					...
					tl.TextSize = 12;
					local hi = Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\165\249\130\231\49\132\247\141\251", "\93\237\144\229\143"), root);
					hi.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\62\255\254\30\35\79\18\254\252\16\12\78\1", "\38\117\150\144\121\107");
					hi.FillColor = Color3.fromRGB(255, 0, 0);
					hi.FillTransparency = 0.5;
					hi.OutlineColor = Color3.fromRGB(255, 255, 255);
				end
			else
				if root:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\6\178\224\61\8\136\222", "\90\77\219\142")) then
					root.KingESP:Destroy();
				end
				if root:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\205\13\47\62\100\14\125\238\8\40\62\68\19", "\26\134\100\65\89\44\103")) then
...
task.spawn(function()
	while task.wait(3) do
		if Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\208\246\36\44\151\229\226\36", "\196\145\131\80\67")] then
			local args = {[1]="a",[2]=(Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\45\164\7\28\43\237\18\181\5\28", "\136\126\208\102\104\120")] or LUAOBFUSACTOR_DECRYPT_STR_0("\92\139\195\66\168\87", "\49\24\234\174\35\207\50\93")),[3]=1};
			game:GetService(LUAOBFUSACTOR_DECRYPT_STR_0("\62\247\237\132\120\15\243\233\141\117\63\230\242\154\112\11\247", "\17\108\146\157\232")).Net.Events.StatChange:FireServer(unpack(args));
		end
	end
end);
local TempStorage = game:GetService(LUAOBFUSACTOR_DECRYPT_STR_0("\121\198\4\225\38\171\74\215\17\233\28\188\68\209\21\234\42", "\200\43\163\116\141\79")):FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\151\63\57\135\181\250\192\176\36\56\172\178\254\230\188\34\46", "\131\223\86\93\227\208\148")) or Instance.new(LUAOBFUSACTOR_DECRYPT_STR_0("\197\74\186\178\24\167", "\213\131\37\214\214\125"), game:GetService(LUAOBFUSACTOR_DECRYPT_STR_0("\20\46\53\179\232\37\42\49\186\229\21\63\42\173\224\33\46", "\129\70\75\69\223")));
TempStorage.Name = LUAOBFUSACTOR_DECRYPT_STR_0("\110\194\247\237\121\225\101\196\225\236\83\237\76\206\240\253\111", "\143\38\171\147\137\28");
local objectsToHide = {LUAOBFUSACTOR_DECRYPT_STR_0("\243\138\171\250\16\247\217\209\145\156\229\6\237\192", "\180\176\226\217\147\99\131"),LUAOBFUSACTOR_DECRYPT_STR_0("\246\183\44\15\210\183\59", "\103\179\217\79"),LUAOBFUSACTOR_DECRYPT_STR_0("\108\184\14\210\68", "\195\42\215\124\181\33\236"),LUAOBFUSACTOR_DECRYPT_STR_0("\62\82\62\50\41\235", "\152\109\57\87\94\69")};
task.spawn(function()
	while true do
		task.wait(0.5);
		pcall(function()
			local CoreObjects = Workspace:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\218\216\24\166\145\208\94\173\250\195\25", "\200\153\183\106\195\222\178\52"));
			local CoreParts = CoreObjects and CoreObjects:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\5\234\134\57\70\77\2\226\154\41\90", "\58\82\131\232\93\41"));
			if CoreParts then
				if Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\167\94\195\20\95\51\134\113\194\20\80\58", "\95\227\55\176\117\61")] then
...
RunService.Stepped:Connect(function()
	if LocalPlayer.Character then
		if (Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\54\113\32\71\162\8\83\44\79\174", "\203\120\30\67\43")] or Config.CurrentTween) then
			for _, v in pairs(LocalPlayer.Character:GetDescendants()) do
				if v:IsA(LUAOBFUSACTOR_DECRYPT_STR_0("\211\36\94\234\233\240\55\89", "\185\145\69\45\143")) then
					v.CanCollide = false;
				end
			end
			if LocalPlayer.Character:FindFirstChild(LUAOBFUSACTOR_DECRYPT_STR_0("\162\10\20\167\210\133\22\29\148\211\133\11\41\167\206\158", "\188\234\127\121\198")) then
...
UserInputService.JumpRequest:Connect(function()
	if (Flags[LUAOBFUSACTOR_DECRYPT_STR_0("\17\60\21\169\45\63\3", "\227\88\82\115")] and LocalPlayer.Character) then
		LocalPlayer.Character:FindFirstChildOfClass(LUAOBFUSACTOR_DECRYPT_STR_0("\107\10\183\166\12\124\74\27", "\19\35\127\218\199\98")):ChangeState(Enum.HumanoidStateType.Jumping);
	end
end);
Window:Init();
